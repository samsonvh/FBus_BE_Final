...
builder.Services.AddCors(options =>
{
    ...
    {
        builder.WithOrigins("http://localhost:3000", "http://127.0.0.1:5500", "http://localhost:5500", "https://fbus-admin-portal.vercel.app", "https://f-bus-map-v2.vercel.app").AllowAnyMethod().AllowAnyHeader();
    });
});
